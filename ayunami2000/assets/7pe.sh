...
qemu-system-x86_64 -m 2G -device VGA,vgamem_mb=128 -net nic,model=e1000 -net user -hda /root/7pe.img -cdrom /root/7pe.iso -rtc base=localtime,clock=host -smp cores=4,threads=4 -usbdevice tablet